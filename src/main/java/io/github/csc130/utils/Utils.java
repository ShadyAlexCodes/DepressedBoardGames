/**
 * @author Xander
 * @createdOn 1/31/2023 at 1:34 PM
...
public class Utils {
    ...
    public enum TextColor {BLACK, RED, GREEN, YELLOW, BLUE, PURPLE, CYAN, WHITE,
        DEFAULT}
    ...
    public enum BackgroundColor {BLACK,RED, GREEN, YELLOW, BLUE, PURPLE, CYAN,
        WHITE, DEFAULT}
    ...
    //endregion
    /**
     * Resets the text color and background color to Utils default values
     */
    private static final String RESET = "\u001B[0m";
    public static void writeLnYellow(String text){
        System.out.println(Utils.YELLOW + text + RESET);
    }
    public static void writeLnBlue(String text){
        System.out.println(Utils.BLUE + text + RESET);
    }
    public static void writeLnRed(String text){
        System.out.println(Utils.RED + text + RESET);
    }
    public static void writeLnGreen(String text){
        System.out.println(Utils.GREEN + text + RESET);
    }
    public static void writeLnPurple(String text){
        System.out.println(Utils.PURPLE + text + RESET);
    }
    public static void writeLnCyan(String text){
        System.out.println(Utils.CYAN + text + RESET);
    }
    public static void writeLnWhite(String text){
        System.out.println(Utils.WHITE + text + RESET);
    }
    public static void writeLnBlack(String text){
        System.out.println(Utils.BLACK + text + RESET);
    }
    /**
     * Gets an CHAR input from the Utils.
     * sorting.library.Utils will keep asking until a valid response is provided.
     ...
     * sorting.library.Utils will keep asking until a valid response is provided.
     * @param message  Message to show to the user as to what you are requesting
     * @param textColor UtilsTextColor of the text when written
     * @return Returns a char value representing the users input
     */
    ...
    /**
     * Gets an BOOLEAN input from the Utils.
     * sorting.library.Utils will keep asking until a valid response is provided.
     Case-insensitive.
     * Uses the default text color
     * @param message  Message to show to the user as to what you are requesting
     ...
     */
    public static boolean getBooleanInput(String message, String positive, String
            negative){
    ...
    /**
     * Gets an DOUBLE input from the Utils.
     * sorting.library.Utils will keep asking until a valid response is provided.
     * Uses the default text color
     * @param message  Message to show to the user as to what you are requesting
    ...
    /**
     * Gets an FLOAT input from the Utils.
     * sorting.library.Utils will keep asking until a valid response is provided.
     * Uses the default text color
     * @param message  Message to show to the user as to what you are requesting
    ...
    /**
     * Gets an LONG input from the Utils.
     * sorting.library.Utils will keep asking until a valid response is provided.
     * Uses the default text color
     * @param message  Message to show to the user as to what you are requesting
    ...
    /**
     * Gets an INT input from the Utils.
     * sorting.library.Utils will keep asking until a valid response is provided.
     * Uses the default text color
     * @param message  Message to show to the user as to what you are requesting
    ...
    /**
     * Gets a String input from the Utils.
    ...
    /**
     * Writes to the Utils using the default text color and background color.
     * Does not append the newline. Text stays on the same line.
     * @param message The message to write to the Utils
     */
    public static void write(String message){write(message, TextColor.DEFAULT,
            BackgroundColor.DEFAULT);}
    /**
     * Writes to the Utils using the provided text color and default background 
     color.
     * Does not append the newline. Text stays on the same line.
     * @param message The message to write to the Utils
     * @param textColor The UtilsTextColor to write the text in
     */
    public static void write(String message, TextColor textColor){
        System.out.print(getBackgroundColorText(BackgroundColor.DEFAULT) +
                getTextColorText(textColor) + message + RESET);
    }
    /**
     * Writes the message to the Utils using the privided text and background 
     color
     * Does not append the newline. Text stays on the same line.
     * @param message The message to write to the Utils
     * @param textColor The UtilsTextColor to write the text in
     * @param backgroundColor The UtilsBackgroundColor to place behind the text
     */
    public static void write(String message, TextColor textColor, BackgroundColor
            backgroundColor){
        System.out.print(getBackgroundColorText(backgroundColor) +
                getTextColorText(textColor) + message + RESET);
    }
    /**
     * Writes to the Utils using the default text color and background color.
     ...
     * @param message The message to write to the Utils
     */
    public static void writeLn(String message){ writeLn(message, TextColor.DEFAULT,
            BackgroundColor.DEFAULT);}
    /**
     * Writes to the Utils using the provided text color and default background 
     color.
     ...
     * @param textColor The UtilsTextColor to write the text in
     */
    public static void writeLn(String message, TextColor textColor)
    { writeLn(message, textColor, BackgroundColor.DEFAULT);}
    /**
     * Writes the message to the Utils using the provided text and background 
     color
     ...
     * @param backgroundColor The UtilsBackgroundColor to place behind the text
     */
    public static void writeLn(String message, TextColor textColor, BackgroundColor
            backgroundColor){
        System.out.println(getBackgroundColorText(backgroundColor) +
                getTextColorText(textColor) + message + RESET);
    }
    ...
    private static String getBackgroundColorText(BackgroundColor backgroundColor){
        switch(backgroundColor){
            case RED:
                return Utils.RED_BACKGROUND;
            case GREEN:
                return Utils.GREEN_BACKGROUND;
            case YELLOW:
                return Utils.YELLOW_BACKGROUND;
            case BLUE:
                return Utils.BLUE_BACKGROUND;
            case PURPLE:
                return Utils.PURPLE_BACKGROUND;
            case CYAN:
                return Utils.CYAN_BACKGROUND;
            case BLACK:
                return Utils.BLACK_BACKGROUND;
            case WHITE:
                return Utils.WHITE_BACKGROUND;
            default:
                return RESET;
        }
    }
